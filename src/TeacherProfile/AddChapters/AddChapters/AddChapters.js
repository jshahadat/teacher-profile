...
const AddChapters = () => {
    ...
    const handleSubmit = event => {
        ...
        const chapterNo = form.chapterNo.value
        const addTodos = {
            email: user?.email,
            courseTitle,
            courseCode,
        ...
        fetch('https://assignment-twelfth-server.vercel.app/addchapter', {
            method: 'POST',
            headers: {
                                                ...
                                                <section className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                                                    ...
                                                    <div className='-mx-3 md:flex mb-6'>
                                                        <div className="md:w-1/3 px-3 mb-6 md:mb-0">
                                                            ...
                                                            <input className="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" type="number" name="chapterNo"
                                                                placeholder="Chapter No." required />
                                                        </div>
                                                        <div className=' md:w-2/3 px-3'>
                                                            <label class="uppercase tracking-wide text-black text-xs font-bold mb-2" htmlFor="title">
                                                                CHAPTER NAME*
                                                            </label>
                                                            <input className="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" type="text" name="chapterName"
                                                    ...
                                                    <div className='-mx-3 md:flex mb-6'>
                                                        <div className='md:w-full  px-3'>
                                                            ...
                                                            <input className="w-full h-36 bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" type="text" name="chapter"
                                                                placeholder="Chapter Outcome" required />
                                                        </div>
                                                    </div>
                                                    <div className='text-center'>
                                                        <input className='btn btn-primary text-center w-full' type="submit" value="Add Course syllabus" />
                                                    </div>
                                                </section >
                                            </form >

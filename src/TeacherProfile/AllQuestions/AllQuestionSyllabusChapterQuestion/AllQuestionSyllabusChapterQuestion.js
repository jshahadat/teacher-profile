...
import AllQuestionSyllabusChapterQuestionCard from './AllQuestionSyllabusChapterQuestionCard';

const AllQuestionSyllabusChapterQuestion = () => {
                ...
                <div className='diu'>
                    ...
                    <div className='mx-auto mt-12 '>
                        <div className=' w-64 mx-auto '>
                            {
                                chaptersQuestion?.map((questions, i) => <AllQuestionSyllabusChapterQuestionCard
                                    key={questions._id}
                                    questions={questions}
                                    i={i}
                                ></AllQuestionSyllabusChapterQuestionCard>)
                            }
                        </div>
                    </div>
                </div>
...
export default AllQuestionSyllabusChapterQuestion;
...
const Assignments = () => {
    ...
    const handleSubmit = event => {
        ...
        const assignmentTopic = form.assignmentTopic.value
        ...
        fetch('https://assignment-twelfth-server.vercel.app/addassignment', {
            method: 'POST',
            headers: {
                                        ...
                                        <section className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                                            ...
                                            <div className='-mx-3 md:flex mb-6'>
                                                ...
                                                <div className='md:w-full  px-3'>
                                                    ...
                                                    <input className="w-full h-36 bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" type="text" name="assignmentTopic"
                                                        placeholder=" ADD ASSIGNMENT TOPIC" required />
                                                </div>
                                            </div>

                                            <div className='text-center'>
                                                <input className='btn btn-primary text-center w-full' type="submit" value="Add Assignment Topic" />
                                            </div>
                                        </section >
                                    </form >
                                </div >

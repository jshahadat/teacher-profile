...
const UpdateChapteroneQuestion = () => {
    const storedQuestion = useLoaderData();
    ...
    const handleUpdateTodo = event => {
        ...
        fetch(`https://assignment-twelfth-server.vercel.app/${storedQuestion._id}`, {
            method: 'PUT',
            headers: {
                                        ...
                                        <div className="">
                                            ...
                                            <div>
                                                <div className=' pb-6 lg:mr-6'>
                                                    <input className="p-2 lg:w-64  w-80  rounded-xl border" onChange={handleInputChange} defaultValue={storedQuestion.question} type="text" name="name"
                                                        placeholder="Add a todo" required />
                                                </div>
                                                <div className=' pb-6 lg:mr-6'>
                                                    <input className="p-2 lg:w-64  w-80  rounded-xl border" onChange={handleInputChange} defaultValue={storedQuestion.number} type="number" name="number"
                                                        placeholder="Number" required />
                                                </div>
                                            </div>
                                            <input className='btn' type="submit" value="update question and mark" />
...
export default UpdateChapteroneQuestion;
...
import ChapterTwoQuestion from './ChapterTwoQuestion';
...
const ChapterTwo = () => {
    ...
    const chapterTwoRandomQuestions = randomArrayValue(chapterTwos, 5);
        ...
        <div>
            {
                ...
                chapterTwoRandomQuestions.map((chapterTwoQuestion, i) => <ChapterTwoQuestion

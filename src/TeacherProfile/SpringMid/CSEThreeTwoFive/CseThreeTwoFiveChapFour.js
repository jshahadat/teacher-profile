...
import CseThreeTwoFiveChapFourQuestion from './CseThreeTwoFiveChapFourQuestion';

const CseThreeTwoFiveChapFour = () => {
    ...
    useEffect(() => {
        fetch("https://assignment-twelfth-server.vercel.app/threetwofivechapterfour?chapCode=4CSE-325Spring", {
            // headers: {
                                ...
                                <div>
                                    {
                                        ...
                                        chapterFourRandomQuestions.map(chapterFourQuestion => <CseThreeTwoFiveChapFourQuestion
                                            key={chapterFourQuestion._id}
                                            chapterFourQuestion={chapterFourQuestion}
                                        ></CseThreeTwoFiveChapFourQuestion>)
                                    }
...
export default CseThreeTwoFiveChapFour;
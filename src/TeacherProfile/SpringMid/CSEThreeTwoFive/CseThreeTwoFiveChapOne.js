...
import CseThreeTwoFiveChapOneQuestion from './CseThreeTwoFiveChapOneQuestion';

const CseThreeTwoFiveChapOne = () => {
    ...
    useEffect(() => {
        fetch("https://assignment-twelfth-server.vercel.app/threetwofivechapterone?chapCode=1CSE-325Spring", {
            // headers: {
                                ...
                                <div>
                                    {
                                        ...
                                        chapterOneRandomQuestions.map(chapterOneQuestion => <CseThreeTwoFiveChapOneQuestion
                                            key={chapterOneQuestion._id}
                                            chapterOneQuestion={chapterOneQuestion}
                                        ></CseThreeTwoFiveChapOneQuestion>)
                                    }
...
export default CseThreeTwoFiveChapOne;
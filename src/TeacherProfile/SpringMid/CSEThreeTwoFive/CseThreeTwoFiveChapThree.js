...
import CseThreeTwoFiveChapThreeQuestion from './CseThreeTwoFiveChapThreeQuestion';

const CseThreeTwoFiveChapThree = () => {
    ...
    const [chapterThree, setChapterThree] = useState([])
    ...
    const chapterThreeRandomQuestions = randomArrayValue(chapterThree, 5);

    useEffect(() => {
        fetch("https://assignment-twelfth-server.vercel.app/threetwofivechapterthree?chapCode=3CSE-325Spring", {
            // headers: {
            //     authorization: `Bearer ${localStorage.getItem('accessToken')}`
            // }
        })
            .then(res => res.json())
            .then(data => setChapterThree(data))
    }, [])
    return (
        <div>
                    ...
                    <div className=' m-auto mb-24 mt-6' style={{ width: "50vw" }}>
                        <div className=' text-center'>
                            ...
                            <div className='flex justify-between justify-items-center'>
                                <h2 className=' font-bold'>Course Code: CSE-213 (Day)</h2>
                                <h2 className=' font-bold'>Course Title: Algorithms</h2>
                            </div>
                        </div>
                        <div className='flex justify-between justify-items-center'>
                                ...
                                <div>
                                    {
                                        ...
                                        chapterThreeRandomQuestions.map(chapterThreeQuestion => <CseThreeTwoFiveChapThreeQuestion
                                            key={chapterThreeQuestion._id}
                                            chapterThreeQuestion={chapterThreeQuestion}
                                        ></CseThreeTwoFiveChapThreeQuestion>)
                                    }
...
export default CseThreeTwoFiveChapThree;
...
import CseTwoOneThreeChapFiveQuestion from './CseTwoOneThreeChapFiveQuestion';

const CseTwoOneThreeChapFive = () => {
    ...
    useEffect(() => {
        fetch("https://assignment-twelfth-server.vercel.app/twoonethreechapterfive?chapCode=5CSE-213Spring", {
            // headers: {
                                ...
                                <div>
                                    {
                                        ...
                                        chapterFiveRandomQuestions.map(chapterFiveQuestion => <CseTwoOneThreeChapFiveQuestion
                                            key={chapterFiveQuestion._id}
                                            chapterFiveQuestion={chapterFiveQuestion}
                                        ></CseTwoOneThreeChapFiveQuestion>)
                                    }
...
export default CseTwoOneThreeChapFive;
...
import CseTwoOneThreeChapFourQuestion from './CseTwoOneThreeChapFourQuestion';

const CseTwoOneThreeChapFour = () => {
    ...
    useEffect(() => {
        fetch("https://assignment-twelfth-server.vercel.app/twoonethreechapterfour?chapCode=4CSE-213Spring", {
            // headers: {
                                ...
                                <div>
                                    {
                                        ...
                                        chapterFourRandomQuestions.map(chapterFourQuestion => <CseTwoOneThreeChapFourQuestion
                                            key={chapterFourQuestion._id}
                                            chapterFourQuestion={chapterFourQuestion}
                                        ></CseTwoOneThreeChapFourQuestion>)
                                    }
...
export default CseTwoOneThreeChapFour;
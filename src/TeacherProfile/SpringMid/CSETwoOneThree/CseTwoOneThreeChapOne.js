...
import CseTwoOneThreeChapOneQuestion from './CseTwoOneThreeChapOneQuestion';

const CseTwoOneThreeChapOne = () => {
    ...
    useEffect(() => {
        fetch("https://assignment-twelfth-server.vercel.app/twoonethreechapterone?chapCode=1CSE-213Spring", {
            // headers: {
                                ...
                                <div>
                                    {
                                        ...
                                        chapterOneRandomQuestions.map(chapterOneQuestion => <CseTwoOneThreeChapOneQuestion
                                            key={chapterOneQuestion._id}
                                            chapterOneQuestion={chapterOneQuestion}
                                        ></CseTwoOneThreeChapOneQuestion>)
                                    }
...
export default CseTwoOneThreeChapOne;
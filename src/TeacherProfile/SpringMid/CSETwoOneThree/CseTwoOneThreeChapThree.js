...
import CseTwoOneThreeChapThreeQuestion from './CseTwoOneThreeChapThreeQuestion';

const CseTwoOneThreeChapThree = () => {
    ...
    useEffect(() => {
        fetch("https://assignment-twelfth-server.vercel.app/twoonethreechapterthree?chapCode=3CSE-213Spring", {
            // headers: {
                                ...
                                <div>
                                    {
                                        ...
                                        chapterThreeRandomQuestions.map(chapterThreeQuestion => <CseTwoOneThreeChapThreeQuestion
                                            key={chapterThreeQuestion._id}
                                            chapterThreeQuestion={chapterThreeQuestion}
                                        ></CseTwoOneThreeChapThreeQuestion>)
                                    }
...
export default CseTwoOneThreeChapThree;
...
import CseTwoOneThreeChapTwoQuestion from './CseTwoOneThreeChapTwoQuestion';

const CseTwoOneThreeChapTwo = () => {
    ...
    useEffect(() => {
        fetch("https://assignment-twelfth-server.vercel.app/twoonethreechaptertwo?chapCode=2CSE-213Spring", {
            // headers: {
                                ...
                                <div>
                                    {
                                        ...
                                        chapterTwoRandomQuestions.map(chapterTwoQuestion => <CseTwoOneThreeChapTwoQuestion
                                            key={chapterTwoQuestion._id}
                                            chapterTwoQuestion={chapterTwoQuestion}
                                        ></CseTwoOneThreeChapTwoQuestion>)
                                    }
...
export default CseTwoOneThreeChapTwo;
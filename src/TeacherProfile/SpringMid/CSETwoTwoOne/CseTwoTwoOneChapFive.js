...
import CseTwoTwoOneChapFiveQuestion from './CseTwoTwoOneChapFiveQuestion';

const CseTwoTwoOneChapFive = () => {
    ...
    useEffect(() => {
        fetch("https://assignment-twelfth-server.vercel.app/twotwoonechapterfive?chapCode=5CSE-221Spring", {
            // headers: {
                                ...
                                <div>
                                    {
                                        ...
                                        chapterFiveRandomQuestions.map(chapterFiveQuestion => <CseTwoTwoOneChapFiveQuestion
                                            key={chapterFiveQuestion._id}
                                            chapterFiveQuestion={chapterFiveQuestion}
                                        ></CseTwoTwoOneChapFiveQuestion>)
                                    }
...
export default CseTwoTwoOneChapFive;
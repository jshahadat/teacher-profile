...
import CseTwoTwoOneChapFourQuestion from './CseTwoTwoOneChapFourQuestion';

const CseTwoTwoOneChapFour = () => {
    ...
    useEffect(() => {
        fetch("https://assignment-twelfth-server.vercel.app/twotwoonechapterfour?chapCode=4CSE-221Spring", {
            // headers: {
                                ...
                                <div>
                                    {
                                        ...
                                        chapterFourRandomQuestions.map(chapterFourQuestion => <CseTwoTwoOneChapFourQuestion
                                            key={chapterFourQuestion._id}
                                            chapterFourQuestion={chapterFourQuestion}
                                        ></CseTwoTwoOneChapFourQuestion>)
                                    }
...
export default CseTwoTwoOneChapFour;
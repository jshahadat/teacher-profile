...
import CseTwoTwoOneChapOneQuestion from './CseTwoTwoOneChapOneQuestion';

const CseTwoTwoOneChapOne = () => {
    ...
    useEffect(() => {
        fetch("https://assignment-twelfth-server.vercel.app/twotwoonechapterone?chapCode=1CSE-221Spring", {
            // headers: {
                                ...
                                <div>
                                    {
                                        ...
                                        chapterOneRandomQuestions.map(chapterOneQuestion => <CseTwoTwoOneChapOneQuestion
                                            key={chapterOneQuestion._id}
                                            chapterOneQuestion={chapterOneQuestion}
                                        ></CseTwoTwoOneChapOneQuestion>)
                                    }
...
export default CseTwoTwoOneChapOne;
...
import CseTwoTwoOneChapThreeQuestion from './CseTwoTwoOneChapThreeQuestion';

const CseTwoTwoOneChapThree = () => {
    ...
    useEffect(() => {
        fetch("https://assignment-twelfth-server.vercel.app/twotwoonechapterthree?chapCode=3CSE-221Spring", {
            // headers: {
                    ...
                    <div className=' m-auto mb-24 mt-6' style={{ width: "50vw" }}>
                        <div className=' text-center'>
                            ...
                            <div className='flex justify-between justify-items-center'>
                                <h2 className=' font-bold'>Course Code: CSE-221 (Day)</h2>
                                <h2 className=' font-bold'>Course Title: Object Oriented Programming</h2>
                            </div>
                        </div>
                        <div className='flex justify-between justify-items-center'>
                                ...
                                <div>
                                    {
                                        ...
                                        chapterThreeRandomQuestions.map(chapterThreeQuestion => <CseTwoTwoOneChapThreeQuestion
                                            key={chapterThreeQuestion._id}
                                            chapterThreeQuestion={chapterThreeQuestion}
                                        ></CseTwoTwoOneChapThreeQuestion>)
                                    }
...
export default CseTwoTwoOneChapThree;
...
import CseTwoTwoOneChapTwoQuestion from './CseTwoTwoOneChapTwoQuestion';

const CseTwoTwoOneChapTwo = () => {
    ...
    useEffect(() => {
        fetch("https://assignment-twelfth-server.vercel.app/twotwoonechaptertwo?chapCode=2CSE-221Spring", {
            // headers: {
                                ...
                                <div>
                                    {
                                        ...
                                        chapterTwoRandomQuestions.map(chapterTwoQuestion => <CseTwoTwoOneChapTwoQuestion
                                            key={chapterTwoQuestion._id}
                                            chapterTwoQuestion={chapterTwoQuestion}
                                        ></CseTwoTwoOneChapTwoQuestion>)
                                    }
...
export default CseTwoTwoOneChapTwo;
...
import CseTwoTwoSixChapFiveQuestion from './CseTwoTwoSixChapFiveQuestion';

const CseTwoTwoSixChapFive = () => {
    ...
    useEffect(() => {
        fetch("https://assignment-twelfth-server.vercel.app/twotwosixchapterfive?chapCode=5CSE-226Spring", {
            // headers: {
                                ...
                                <div>
                                    {
                                        ...
                                        chapterFiveRandomQuestions.map(chapterFiveQuestion => <CseTwoTwoSixChapFiveQuestion
                                            key={chapterFiveQuestion._id}
                                            chapterFiveQuestion={chapterFiveQuestion}
                                        ></CseTwoTwoSixChapFiveQuestion>)
                                    }
...
export default CseTwoTwoSixChapFive;
...
import CseTwoTwoSixChapOneQuestion from './CseTwoTwoSixChapOneQuestion';

const CseTwoTwoSixChapOne = () => {
    ...
    useEffect(() => {
        fetch("https://assignment-twelfth-server.vercel.app/twotwosixchapterone?chapCode=1CSE-226Spring", {
            // headers: {
                                ...
                                <div>
                                    {
                                        ...
                                        chapterOneRandomQuestions.map(chapterOneQuestion => <CseTwoTwoSixChapOneQuestion
                                            key={chapterOneQuestion._id}
                                            chapterOneQuestion={chapterOneQuestion}
                                        ></CseTwoTwoSixChapOneQuestion>)
                                    }
...
export default CseTwoTwoSixChapOne;
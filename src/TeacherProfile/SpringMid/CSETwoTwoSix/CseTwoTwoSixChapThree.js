...
import CseTwoTwoSixChapThreeQuestion from './CseTwoTwoSixChapThreeQuestion';

const CseTwoTwoSixChapThree = () => {
    ...
    useEffect(() => {
        fetch("https://assignment-twelfth-server.vercel.app/twotwosixchapterthree?chapCode=3CSE-226Spring", {
            // headers: {
                                ...
                                <div>
                                    {
                                        ...
                                        chapterThreeRandomQuestions.map(chapterThreeQuestion => <CseTwoTwoSixChapThreeQuestion
                                            key={chapterThreeQuestion._id}
                                            chapterThreeQuestion={chapterThreeQuestion}
                                        ></CseTwoTwoSixChapThreeQuestion>)
                                    }
...
export default CseTwoTwoSixChapThree;
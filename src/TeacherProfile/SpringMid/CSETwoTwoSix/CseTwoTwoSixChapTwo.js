...
import CseTwoTwoSixChapTwoQuestion from './CseTwoTwoSixChapTwoQuestion';

const CseTwoTwoSixChapTwo = () => {
    ...
    useEffect(() => {
        fetch("https://assignment-twelfth-server.vercel.app/twotwosixchaptertwo?chapCode=2CSE-226Spring", {
            // headers: {
                                ...
                                <div>
                                    {
                                        ...
                                        chapterTwoRandomQuestions.map(chapterTwoQuestion => <CseTwoTwoSixChapTwoQuestion
                                            key={chapterTwoQuestion._id}
                                            chapterTwoQuestion={chapterTwoQuestion}
                                        ></CseTwoTwoSixChapTwoQuestion>)
                                    }
...
export default CseTwoTwoSixChapTwo;
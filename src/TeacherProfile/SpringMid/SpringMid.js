...
import ChpaterOne from '../Chpters/ChpaterOne/ChpaterOne';
            ...
            <div className=' m-auto mb-24 mt-6' style={{ width: "50vw" }}>
                <div className=' text-center'>
                    ...
                    <div className='flex justify-between justify-items-center'>
                        <h2 className=' font-bold'>Course Code: GED-111 (Day)</h2>
                        <h2 className=' font-bold'>Course Title: Bangladesh </h2>
                    </div>
                </div>
                <div className='flex justify-between justify-items-center'>

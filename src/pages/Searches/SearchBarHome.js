...
import { createBrowserRouter, unstable_HistoryRouter, useLocation, useNavigate, useNavigation } from "react-router-dom";
import { NavBarSearchBar, VoiceModal } from "./NavBarUpdated2";
...
function SearchBarHome() {
    ...
    const SubmitSearchRequest = (e = false, text = "") => {
        ...
        if (searchText.replace(/\s/g, "").length) {
            history.push("/" + searchText, { replace: true });
        }
    };
    // Speech
